...
Builds the flake's cedm package and writes a
result symlink beneath the artifact directory. The NixOS module is exported as
...
nix --extra-experimental-features 'nix-command flakes' build \
    ...
    "path:$PROJECT_ROOT#$PACKAGE_NAME" \
    "${nix_extra[@]}"
